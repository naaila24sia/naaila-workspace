      ...
      <div className="bg-white rounded-[2rem] border border-border shadow-soft overflow-hidden">
                  ...
                  >
                    <td className="px-8 py-5">
                      <div className="flex items-center gap-4">
                        <div
                          className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${owner.color || "from-primary to-purple-600"} text-white flex items-center justify-center font-poppins font-black text-lg border-2 border-white shadow-md transition-transform group-hover:scale-110 group-hover:rotate-3`}
                        >
                          {owner.initial || owner.name.charAt(0)}
                        </div>
                        <div>
                          <div className="flex items-center gap-2">
                            <NavLink to={`/ownerdetail/${owner.id}`}>
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <p className="text-[11px] font-bold text-text-main leading-none italic">
                            {owner.pets[0]}
                            {owner.pets.length > 1 ? `, ${owner.pets[1]}` : ""}
                          </p>
        ...
        <div className="p-6 bg-bg-main/20 border-t border-border flex justify-between items-center">
          <p className="text-xs text-text-soft font-bold uppercase tracking-widest">
            Showing{" "}
            <span className="text-primary">{filteredOwners.length}</span> of{" "}
            {ownersData.length} Pet Parents
          </p>
